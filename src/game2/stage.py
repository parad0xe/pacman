...
from src.game2.ghost import Ghost, GhostID
...
class Stage():
    ...
    def __init__(self, board: list[list[int]], pathfinder: PathFinder, level: int, config: Config) -> None:
        self.board = board
        ...
        self.pacgums = [[0 if cell == 15 else 1
                          for cell in row]
        ...
        self.ghosts: list[Ghost] = [
            ...
            Ghost(GhostID.CLYDE, pathfinder, (self.height - 1, self.width - 1),)
        ]
